...
const BREADCRUMB_MAP = {
  ...
  clusters: [{ title: "资源管理" }, { title: "K8s 集群" }],
  "k8s-agent": [{ title: "资源管理" }, { title: "Agent 接入" }],
  "resource-onboard": [{ title: "资源管理" }, { title: "纳管资源" }],
...
const PARENT_MAP = {
  ...
  clusters: "resource-mgmt",
  "k8s-agent": "resource-mgmt",
