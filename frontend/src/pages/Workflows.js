...
import ReactFlow, { Controls, MiniMap, Background, addEdge, useNodesState, useEdgesState, MarkerType, Panel } from "reactflow";
...
function CustomNode({ data }) {
  ...
  return (
    <div style={{background:"#fff",border:`2px solid ${info.color||"#d9d9d9"}`,borderRadius:8,padding:"8px 12px",minWidth:160,boxShadow:"0 2px 8px rgba(0,0,0,0.1)"}}>
