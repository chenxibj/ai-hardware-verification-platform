...
**慢节点检测标准：** 单节点 busbw 低于实测 max_algbw 的 80% → 标记为疑似慢节点
...
| C7: 3600/500 | prefill<3000ms, decode<50ms | — | — | —% | — | — | —% |
