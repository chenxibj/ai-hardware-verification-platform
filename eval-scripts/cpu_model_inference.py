...
def main():
    ...
    for cfg in configs:
        ...
        for bs in batch_sizes:
            ...
            results.append({
                ...
                "input_shape":"[{},{}]".format(bs, cfg["in"]),"output_shape":"[{},{}]".format(bs, cfg["out"]),
    ...
    output = {
        "benchmark_name":"cpu_model_inference","benchmark_version":"1.1",
        "timestamp":datetime.now().isoformat(),"system_info":get_system_info(),
        "config":{"iterations":iterations,"batch_sizes":batch_sizes,"model_filter":model_filter},"results":results,
